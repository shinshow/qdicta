...
strings = {
    ...
    "settings": {
        ...
        "model": {
            "title": "모델",
            "selected_model": "ASR 모델",
            "output_mode": "출력",
            "download": "선택한 모델 다운로드",
            "delete": "선택한 모델 삭제",
            "delete_confirm_title": "다운로드한 모델을 삭제할까요?",
            "delete_confirm_message": "선택한 모델을 vvrite의 Application Support 폴더에서 삭제합니다. 나중에 다시 다운로드할 수 있습니다.",
            "downloaded": "다운로드됨",
